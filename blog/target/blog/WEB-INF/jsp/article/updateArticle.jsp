...
<main role="main" class="container">
    <div class="row row-offcanvas row-offcanvas-right main-wrapper">
        ...
        <form class="col-12 col-md-10" id="content-body" method="post" action="${pageContext.request.contextPath}/article/updateArticle">
            <div class="title-box clearfix d-flex">
                <input type="text" id="txtTitle" maxlength="100" name="title" placeholder="输入文章标题" value="${article.title}">
            </div>

            <div class="title-box clearfix d-flex">
                <input type="text" id="txtKeyword" maxlength="100" name="keyword" placeholder="输入文章关键字" value="${article.keyword}">
            </div>
                ...
                <div class="pos-box">
                    <div class="form-group row form-control-sm">
                        ...
                        <div class="txt-box">
                            ...
                            <input type="hidden" value="${article.typeId}" id="editTypeId" name="oldTypeId">
                            <input type="hidden" value="${article.context}" id="editContext">
                    ...
                    <div class="opt-box row unfull">
                        ...
                        <div class="txt-box">
                            <button id="btnPublish" type="submit" class="btn btn-outline-danger">修改博客</button>
            ...
            if(result.success){
                $.each(result.data,function(index,value){
                    ...
                    if(typeId == value.typeId){
                        str = "<option value='" + value.typeId + "' selected = 'selected'>" + value.typeName+ "</option>";
                    }else{
